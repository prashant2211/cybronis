...
const HomePage = () => {
  const homeStructuredData = {
    ...
    "@type": "Organization",
    "name": "Cybronis",
    "alternateName": ["cybronis", "CYBRONIS", "Cybronis AI", "CybronisAI"],
    "url": "https://cybronis.com",
    "logo": "https://cybronis.com/logo.png",
    "description": "Cybronis - Leading web development and application development company. Expert in website making, web application development, custom software solutions, and mobile app development.",
    "foundingDate": "2024",
    "founder": {
      "@type": "Person",
      "name": "Prashant Raj",
    ...
    "offers": [
      {
        ...
        "description": "Professional web development services including website making, web application development, and custom website solutions",
        "provider": {
          "@type": "Organization",
          "name": "Cybronis"
        }
      },
      {
        ...
        "description": "Expert application development and application making services for web and mobile platforms",
        "provider": {
          "@type": "Organization",
          "name": "Cybronis"
        }
  ...
  return (
    <>
      <SEO
        title="Cybronis - Web Development & Application Development Company | Website Making Experts"
        description="Cybronis is the leading web development and application development company. Expert in website making, web application development, custom software solutions, and mobile app development. Get professional web development services from Cybronis."
        keywords={['web development', 'application development', 'website making', 'web application development', 'application making']}
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
              <span className="block">Cybronis - Web Development</span>
            ...
            <p className="text-xl md:text-2xl text-gray-200 w-full leading-relaxed max-w-3xl mx-auto">
              Cybronis is the leading web development and application development company. Expert in website making, web application development, custom software solutions, and mobile app development. We help founders and business owners turn ideas into real digital products – custom websites, Android & iOS apps, dashboards and more. Professional web development services delivered end-to-end.
            </p>
    ...
    <div className="sr-only" aria-hidden="true">
      <h2>Cybronis - Web Development and Application Development</h2>
      <p>Cybronis is a premier web development company specializing in website making, web application development, and application development services. Our expert team provides professional web development, application making, and custom software solutions. Whether you need website development, web app development, or mobile app development, Cybronis delivers exceptional results. As a leading web development company and application development company, we offer comprehensive services including website making, web application development, and application making. Trust Cybronis for all your web development and application development needs.</p>
      <h3>Web Development Services</h3>
      <p>Professional web development services including website making, web application development, and custom website solutions. Expert web development company providing top-quality web development and application development services.</p>
      <h3>Application Development Services</h3>
      <p>Expert application development and application making services for web and mobile platforms. Professional application development company specializing in web application development and custom software solutions.</p>
      <h3>Website Making Services</h3>
      <p>Professional website making services with modern design and development. Expert website development and web application development for businesses of all sizes.</p>
    </div>
    </>
  );
};
